# FileInUse
This is a WinForms Graphical User Interface written in C# that integrates the Microsoft's Sysinternals Handle to identify processes using a file or directory.
